...
const TEMPLATES = {
  ...
  mug: (artwork) =>
    `Hyper-realistic studio product photograph of a real glossy white ceramic 350ml coffee mug. Photographed with a professional DSLR camera, side view, mug placed on a textured grey concrete surface with soft directional daylight casting a realistic shadow. The mug is straight-sided with a curved handle on the right. The ceramic glaze is visible and reflective. A bold vintage screen-printed graphic is printed on the front of the mug (visible clearly, wrapping slightly with the curvature): ${artwork}. Style of an Amazon premium product listing photo. STRICT: This must look like a photograph of a real mug — NOT an illustration, NOT a cartoon, NOT a vector drawing, NOT a flat 2D design. Photorealistic only. ${STRICT_RULES}`,

  sticker: (artwork) =>
    `Hyper-realistic top-down product photograph of a real matte vinyl die-cut sticker placed on a textured grey concrete surface. The sticker is a physical real-world object with a 3mm white die-cut border around the artwork edge. The bottom-left corner of the sticker is slightly peeled up off the surface revealing the white adhesive backing, casting a small real shadow under it. The printed graphic on the sticker is crisp: ${artwork}. Shot with professional camera in soft daylight. STRICT: This must look like an actual photograph of a real vinyl sticker — NOT an illustration, NOT a cartoon, NOT a flat vector graphic. The sticker has visible material texture, shadows, and depth. ${STRICT_RULES}`,
